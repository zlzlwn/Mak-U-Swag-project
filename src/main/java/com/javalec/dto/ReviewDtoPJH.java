...
public class ReviewDtoPJH {
	...
	public ReviewDtoPJH(int noSeq, String userId, String noCategory, String noContent, String noImage, int noCount,
	...
	public ReviewDtoPJH(String noTitle, String noCategory, String noDate, String noContent,String noImage) {
		super();
