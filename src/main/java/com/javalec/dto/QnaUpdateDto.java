...
public class QnaUpdateDto {
	...
	public QnaUpdateDto(int qnaSeq, String userId, String qnaTitle, String qnaCategory, String qnaContent,
			String qnaImage, int qnaCount, String qnaDate, String qnaPasswd) {
		super();
		this.qnaSeq = qnaSeq;
		this.userId = userId;
