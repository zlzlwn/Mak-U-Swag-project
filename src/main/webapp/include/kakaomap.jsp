		...
		<div class="main">
			...
			<div class="mapwrap">
				...
				<script type="text/javascript">
					...
					const positions = [ {
						content : "<div style='padding: 5px; text-align: center;'><h5>Mak U Swag</h5><img src='../images/CompanyLogo.png' alt='로고' class='logo-img' width='50px' height='50px'></div>",
			...
			<table class="table" style="minWidth: 700px">
				<tbody style="border: 1px solid lightgray">
					<tr>
						...
						<td>서울특별시 강남구 강남대로 78길 8	 한국빌딩 4층 (T: 02-123-4567)</td>
					</tr>
					<tr>
						<td style="borderRight: 1px solid lightgray">버스</td>
						<td>강남역 정류장 지선 9202 일반 4312</td>
					</tr>
					<tr>
						<td style="borderRight: 1px solid lightgray">지하철</td>
						<td>지하철 2호선 강남역 4번출구 200m</td>
					</tr>
				</tbody>
			</table>
