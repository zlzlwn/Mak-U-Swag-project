...
<div class="wrap">
  ...
  <ul class="accordion-list">
    ...
    <li class="accordion-item">
      <a href="#" class="accordion-link">
        <div class="accordion-name">
          <span class="number">교환/환불</span>
          교환 환불이 불가능 한 경우
        </div>
      </a>
      <div class="accordion-desc">
			- 배송 완료 시점으로부터 주말 제외 7일 이내 페이드룸 사무실에 도착하지 않을 시 교환/반품이 불가능합니다.<br><br>
			- 일반적인 시착 외에 외출의 흔적(이염, 늘어짐, 보풀 등, 택 제거)이 발견되면 교환/반품이불가능합니다.<br> <br> 
			- 1~3 cm 이내의 실측 오차는 교환/반품은 가능하나 배송비가청구됩니다.<br> <br> 
			- 린넨 제품의 경우 보풀처럼 보이는 부위는 원단의 특성으로 무료교환/반품 대상이 아닙니다.<br> <br> 
			- 소가죽 수제화의 경우 미세한 스크래치가 있을 수있으며 이는 무료 교환/반품 대상이 아닙니다.<br> <br> 
    ...
    <li class="accordion-item">
      ...
      <div class="accordion-desc">
			...
			교환, 환불 등의이유로 최종 구매액이 10만원 이하로 내려가면 배송비가 청구됩니다.<br> <br>
    ...
    <li class="accordion-item">
      ...
      <div class="accordion-desc">
			핸드폰 결제 취소는 당월에만 가능합니다.<br> <br> 
			예를 들어 03.31 주문, 04.01취소가 불가능합니다.<br> <br> 
			이런 경우에는 현금 환불로 진행됩니다.<br> <br>
    ...
    <li class="accordion-item">
      ...
      <div class="accordion-desc">
		...
		Mak U Swag은 최대한 실물 색상에 가까운 사진과 정확한 사이즈 기재를 하고 있으나 컴퓨터 해상도에 따라 색상 차이가
		있을 수 있으며,<br> 
